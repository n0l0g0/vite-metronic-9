 ...
 * 
 * *** DEMO MODE: Auth bypassed for demo purposes ***
 */
export const RequireAuth = () => {
  // *** DEMO MODE: Comment out auth logic and allow direct access ***
  ...
  // *** DEMO MODE: Always allow access without authentication ***
  console.log('RequireAuth: DEMO MODE - Bypassing authentication');
